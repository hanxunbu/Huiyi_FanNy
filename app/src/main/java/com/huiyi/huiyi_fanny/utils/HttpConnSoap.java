...
public class HttpConnSoap {
	...
	public ArrayList<String> GetWebServre(String methodName, ArrayList<String> Parameters, ArrayList<String> ParValues,String fuwuqi_url) {
		...
		try {
			...
			ArrayList Values1 = inputStreamtovaluelist(inStream, methodName);
			return Values1;
 ...
 */
	...
	public String Getjson2(String fmethodName,String paramString2, String paramString3, String fuwuqi_url) {
		try {
			String nameSpace = "http://tempuri.org/";
			String methodName = fmethodName;
			// URL
			...
			String soapAction = "http://tempuri.org/" + fmethodName;
			SoapObject soapObject = new SoapObject(nameSpace, methodName);
			soapObject.addProperty(paramString2, paramString3);
			SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
			envelope.bodyOut = soapObject;
	...
	public String Getjson3(String code, String fmethodName, String fuwuqi_url) {
